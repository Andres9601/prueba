...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public Collection<GrantedAuthority> mapToAuthorities(List<Rol> rols){
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new org.springframework.security.core.userdetails.User(user.getUsername(),user.getPassword(),mapToAuthorities(getRoles(user)));
    }

    List<Rol> getRoles(User user){
        List rols = new ArrayList<>();
        user.getUserRols().forEach(userRol -> rols.add(userRol.getRol()));
        return rols;
    }
